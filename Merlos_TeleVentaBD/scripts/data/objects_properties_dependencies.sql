...
USING (VALUES
  (N'sysUser',N'RoleId',N'UserName',1,1,NULL,NULL,NULL,N'(Id<>''admins'' or ''{{currentUserLogin}}''=''admin'')',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'ConfConnectionString',0,1)
