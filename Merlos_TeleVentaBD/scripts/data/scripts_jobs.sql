...
USING (VALUES
  (N'MERLOSCsj-db29-4fc7-be2c-ab69fb5e0621',N'MI_ControlVersion',N'Regenera el contenido de la base de datos de DATOS. Vistas, procedimientos, etc.','2021-06-18T15:43:00',N'S',N' declare    @EJERCICIO varchar(4) = (select EJERCICIO from Configuracion_SQL)
                ...
                END
            ',N'DataConnectionString',1,'2021-06-18T16:51:00','2021-06-18T16:51:00',NULL,1)
