...
const Preferences = registerPlugin('Preferences', {
    web: () => __sc_import_app('./web-6ac457ef.js').then(m => new m.PreferencesWeb()),
});
...
class Webapi {
    ...
    getCollection(objectName, filter = null, page = 0, pageSize = 500, orderBy = null, isDefined = false) {
