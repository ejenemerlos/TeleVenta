import { m as msg, u as util } from './messages-dc846cc4.js';
import { j as jquery } from './jquery-4ed57fb2.js';

var gps;
(function (gps) {
    function getCoords(geoTimeout = 10000, maximumAge = 10) {
        return new Promise((resolve, reject) => {
            var geoOpt = { maximumAge: maximumAge, timeout: geoTimeout, enableHighAccuracy: true };
            navigator.geolocation.getCurrentPosition(function (position) { resolve(position); }, function (err) { getCoordsError(err); reject(err); }, geoOpt);
        });
    }
