import { m as msg, C as ConftokenProvider } from './messages-dc846cc4.js';
...
(function (nav) {
    ...
    function goGallery(object, objectid, defaults) {
        goPageGallery('gallery', object, objectid, defaults, 'forward');
    }
    ...
    function transferGallery(object, objectid, defaults) {
        goPageGallery('gallery', object, objectid, defaults, 'back');
    }
    ...
    nav.goPage = goPage;
    function goPageGallery(type, object, objectid, defaults, direction) {
        var esc = encodeURIComponent;
    ...
    nav.goPageGallery = goPageGallery;
    function currentUrl() {
        let router = document.querySelector('ion-router');
